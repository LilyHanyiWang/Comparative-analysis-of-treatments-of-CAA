...
**logistic regression with Generalized Estimating Equations for categorical variables**

`POSTOP_CEREBROSX`, `POSTOP_SPINAL_ISCHEMIA`, `POSTOP_DIALYSIS`, `POSTOP_LOS`,  `POSTOP_COMPLICATIONS`, `POSTOP_LEGEMBO`, `POSTOP_RESPIRATORY`, `RETX_R_RTOR`, `BRANCH_POST`, `TOTAL_LOS`,`ICUSTAY`, `POSTOP_INTISCH`


**linear regression with Generalized Estimating Equations for continuous variables**

`POSTOP_GFR`, `POSTOP_PRBC` 
