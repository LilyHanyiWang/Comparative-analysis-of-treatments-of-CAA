...
What is the point of filtering `BRANCH_POST`.
*Filter `BRANCH_POST` based on the same criteria?*
...
# drop missing data
TEVAR = TEVAR %>% filter(lrenal %in% c(1,2,3)
                         |rrenal %in% c(1,2,3)
                         |celiac %in% c(1,2,3)
                         |lsub %in% c(1,2,3)
                         |sma %in% c(1,2,3))
