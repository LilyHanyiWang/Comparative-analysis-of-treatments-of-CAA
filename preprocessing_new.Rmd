...
Compare the data from July 2021 and September 2021. Keep the most updated ones by merging `TEVAR_LTF_07` with `TEVAR_LTF_09`, and `TEVAR_PROC_07` with `TEVAR_PROC_09` separately.
...
```{r}
# view(duplicated(TEVAR_PROC$PATIENTID))
# TEVAR_PROC[38,]$PATIENTID
# row 38, 454, 813, 977, coresponding to PATIENTID 215378,447710,67027,401596

# duplicate = TEVAR_PROC %>% 
#   filter(PATIENTID==215378|PATIENTID==447710|PATIENTID==67027|PATIENTID==401596 ) %>%
