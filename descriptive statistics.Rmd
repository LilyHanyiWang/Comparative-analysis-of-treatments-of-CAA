---
title: "Descriptive Statistics based on the VQI TEVAR Dataset"
...
table1(~ PRIOR_AORSURG+
         ...
         Genetic+
         PROXZONE_DISEASE+DISTZONE_DISEASE+
         ...
         BRANCH_INNO_POST+
         BRANCH_LSUB_VERTPAT+ANESTHESIA_GEN_TIMEEXT+POSTOP_SPINALDRAIN+
...
table1(~ TOTAL_LOS+POSTOP_LOS+
         ...
         BRANCH_LRENAL_POST+BRANCH_RCOMILI_POST+BRANCH_LCOMILI_POST+ICUSTAY+
         ...
         RETX+DC_STATUS+R_LE_ISCH+R_POSTOP_RENAL+R_RTOR
       | PRESENTATION, data = FBVAR)
