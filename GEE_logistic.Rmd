...
- `POSTOP_CEREBROSX`, `POSTOP_SPINAL_ISCHEMIA`, `POSTOP_DIALYSIS`, `TOTAL_LOS`, `POSTOP_LOS`, `ICUSTAY`,  `POSTOP_COMPLICATIONS`, `POSTOP_LEGEMBO`, `POSTOP_RESPIRATORY`, `RETX_R_RTOR`, `BRANCH_POST`
...
```{r fig.cap='Odds ratio plot for TOTAL_LOS',fig.width=10,fig.height=8}

## ------------- TOTAL_LOS  ----------

## ------------- function: geeglm  ----------

# geeglm(TOTAL_LOS ~ PRESENTATION+AGECAT+GENDER+PREOP_SMOKING+PRIOR_AORSURG+PRIOR_CHF+PREOP_DIALYSIS+PATHOLOGY+extent,
#        data = (TEVAR_PROC),
#        id = CENTERID,
#        family = binomial,
#        corstr = "independence")
...
```{r fig.cap='Odds ratio plot for ICUSTAY',fig.width=10,fig.height=8}
...
```{r fig.cap='Odds ratio plot for POSTOP_LOS',fig.width=10,fig.height=8}
